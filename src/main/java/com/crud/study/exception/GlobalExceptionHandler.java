...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleMissingRequestHeaderExceptionException (MissingRequestHeaderException ex) {
    ...
    /**
     * com.google.json 내에 Exception 발생하는 경우
     *
